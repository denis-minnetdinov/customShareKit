...
- (void)dismiss:(BOOL)animated {
    ...
    if (animated) {
        [UIView animateWithDuration:0.5
                         ...
                         animations:^{
                             nav.view.frame = CGRectMake(0, 480, 320, 480);
                         }
...
- (id)init {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"signup_bg.png"]];
        ...
        _webView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"signup_bg.png"]];
...
//    [window addSubview:_modalBackgroundView];
    ...
    [nav.navigationBar setBackgroundImage:[UIImage imageNamed:@"nav_bar_with_logo.png"] forBarMetrics:0];
    UIButton *cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
    UIImage *setImg = [UIImage imageNamed:@"nav_bar_btn_cancel.png"];
    UIImage *setImg2 = [UIImage imageNamed:@"nav_bar_btn_cancel_active.png"];
    [cancelButton setBackgroundImage:setImg forState:UIControlStateNormal];
    [cancelButton setBackgroundImage:setImg2 forState:UIControlStateHighlighted];
    cancelButton.frame = CGRectMake(0,0,setImg.size.width,setImg.size.height);
    [cancelButton addTarget:self action:@selector(cancel) forControlEvents:UIControlEventTouchUpInside];
    
    UIBarButtonItem *leftButtonItem = [[UIBarButtonItem alloc] initWithCustomView:cancelButton];
    [viewController.navigationItem setLeftBarButtonItem:leftButtonItem];
    [leftButtonItem release];
    self.frame = CGRectMake(0, 0, 320, 480);
    
    topSpinner = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhite];;
    [viewController.navigationItem setRightBarButtonItem:[[[UIBarButtonItem alloc] initWithCustomView:topSpinner] autorelease] animated:NO];
    topSpinner.hidesWhenStopped = YES;
